...
try:
    from consent_gate import show_consent_gate
...
def main():
    ...
    if _CONSENT_GATE_AVAILABLE and not st.session_state.get('consent_accepted', False):
        if not show_consent_gate(APP_VERSION):
            return
